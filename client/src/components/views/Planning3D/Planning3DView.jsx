...
// ─────────────────────────────────────────────────────────────
const BONE_MODELS = [
  { id:'skeleton', label:'Full Skeleton',   emoji:'🦴', path:'/models/skeleton.glb',      category:'Systemic',       note:'Whole body axial & appendicular system' },
  { id:'femur',    label:'Femur',           emoji:'🦵', path:'/models/femur.glb',         category:'Lower Limb',     note:'Femoral head, neck, trochanter & shaft' },
  { id:'tibia',    label:'Tibia & Fibula',  emoji:'🦵', path:'/models/tibia.glb',         category:'Lower Limb',     note:'Weight-bearing tibial plateau & shaft' },
  { id:'skull',    label:'Skull',           emoji:'💀', path:'/models/skull.glb',         category:'Axial Skeleton', note:'Complete cranial vault and facial skeleton' },
  { id:'hand',     label:'Upper Limb',      emoji:'💪', path:'/models/hand.glb',          category:'Upper Limb',     note:'Left arm, radius, ulna and humerus' },
  { id:'spine',    label:'Lumbar Spine',    emoji:'🪱', path:'/models/spine.glb',         category:'Spine',          note:'L1–L5 lumbar vertebral bodies & pedicles' },
  { id:'ribcage',  label:'Ribcage',         emoji:'🫀', path:'/models/ribcage.glb',       category:'Thorax',         note:'True, false ribs & costal cartilage frame' },
  { id:'pelvis-m', label:'Pelvis (M)',      emoji:'🦴', path:'/models/pelvis_male.glb',   category:'Pelvic Girdle',  note:'Ilium, ischium, pubis & acetabulum' },
  { id:'pelvis-f', label:'Pelvis (F)',      emoji:'🦴', path:'/models/pelvis_female.glb', category:'Pelvic Girdle',  note:'Gynecoid pelvic inlet & iliac crest' },
];
