      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 border border-slate-200 bg-white rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-50 flex items-center gap-2 transition"
          >
            <Printer size={16} />
            Print Report
          </button>
      ...
      <div className="bg-gradient-to-br from-white via-slate-50 to-blue-50 rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="pt-4 border-t border-slate-200 flex flex-wrap items-center justify-end gap-3">
            <button
              disabled={isFinalized}
              className="px-5 py-3 border-2 border-slate-200 text-slate-800 rounded-xl font-bold hover:bg-slate-50 transition flex items-center gap-2 disabled:opacity-50 text-sm"
            >
              Save Draft
            </button>
            <button
              ...
              disabled={isFinalized}
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-bold hover:from-blue-700 hover:to-blue-800 transition shadow-xl shadow-blue-600/25 flex items-center gap-2 disabled:opacity-70 text-sm"
            >
              {isFinalized ? (
                <>
